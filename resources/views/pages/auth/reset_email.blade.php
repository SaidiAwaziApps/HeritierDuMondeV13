    ...
    @section('content')
    <div id="form_bloc">
        <form method="post" action="{{ route('authentication.reset_email_handler') }}">
            @csrf
            <div id="form_header">
            ...
            <div id="form_body">
                ...
                <div id="input_bloc">
                    <div class="form-group">
                        <label for="email">
                            <i class="fa fa-envelope"></i> Email:<i id="required-sign">*</i>
                        </label>
                        <input type="email" name="email" id="email" class="form-control" placeholder="Email réinitialisation" maxlength="60" required>
                    </div>
                </div>
