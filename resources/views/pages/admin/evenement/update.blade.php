...
<body>
    ...
    <div id="globalContent">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('evenement.update',['id'=>$evenement->id]) }}" enctype="multipart/form-data" id="register_evenement_form">
                    <div id="form_content">
                        @csrf
                        @method('PUT')          
                        <!-- Events -->
