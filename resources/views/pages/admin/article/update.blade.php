...
<body>
    ...
    <div id="global_content">
        <div class="card">
            <div class="card-header">
                <span class="card-title">
                    <i class="fa fa-blog"></i> Modifier l'article
                </span>
                            ...
                            <div id="first_input_bloc">
                                ...
                                <div id="contenu_bloc">
                                    <div class="form-group">
                                        ...
                                        <textarea name="contenu" id="contenu" class="form-control" cols="30" rows="11" placeholder="Entrer le contentu de l'article" value="{{ $article->contenu }}" required></textarea>
                                    </div>    
                                </div>
                            </div>
        ...
        <script src="{{ asset('script/image/update.js') }}"></script>
