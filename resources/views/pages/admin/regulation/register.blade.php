...
<head>
    ...
    <style>
        ...
        form ul li div textarea[name="denied_images"] {
...
<body>
    ...
    <div class="globalContent">
                    ...
                    <ul>
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <input type="checkbox" name="attempt_all_to_moderated" id="attempt_all_to_moderated" value="oui" checked>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <select name="denied_images[]" id="denied_images" class="form-control" multiple>
                                    ...
                                    <option value="gore.prob">Sang, Blessure</option>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <textarea name="denied_words" id="denied_words" cols="30" rows="2" class="form-control" placeholder="Entrer les mots interdits (Tout commentaire contenant au moins une de ces mots sera place immediatement a la corbeille , d' ou rejete). Espacer par les virgules !!!"></textarea>
                            </div>
                        </li>
                    </ul>
        ...
        <!-- Inclusion script -->
        <script src="{{ asset('script/regulation/register.js') }}"></script>
