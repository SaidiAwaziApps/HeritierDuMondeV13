@if(Route::currentRouteName() == 'admin.questionnement.list')
   <link rel="stylesheet" href="{{ asset('style/pages/admin/questionnement/list.css') }}">
@endif

@if(Route::currentRouteName() == 'admin.questionnement.register_page')
   <link rel="stylesheet" href="{{ asset('style/pages/admin/questionnement/register.css') }}">
@endif

@if(Route::currentRouteName() == 'admin.questionnement.update_page')
